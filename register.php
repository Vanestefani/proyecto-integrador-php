                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            ...
                            <li><a href="shop.php">Inmuebles Comerciales - Venta</a></li>
                            <li><a href="shop.php">Inmuebles Comerciales - Arriendo</a></li>
                            <li><a href="shop.php">Lotes - Venta</a></li>
                            <li><a href="shop.php">VIVIENDA NUEVA </a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="register-form">
                        ...
                        <form action="#">
                            ...
                            <button type="submit" class="site-btn register-btn">REGISTRARME</button>
                        </form>
