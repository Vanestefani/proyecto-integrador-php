            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="./contact.php">CONTACTENOS</a></li>
                        <li><a href="#">MAS</a>
                            <ul class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="contact-title">
                        <h4>CONTACTANOS</h4>
                        <p>Horarios de atencion son de lunes a viernes de 6 am a 10 pm</p>
                    </div>
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="contact-form">
                        <div class="leave-comment">
                            ...
                            <p>Si tiene fallas como usuario en las publicaciones manda tu mensaje y lo contactaremos en breve </p>
